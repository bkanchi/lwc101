        ...
        action.setCallback(this,function(response){
            if(response.getState() === "SUCCESS"){
                ...
                var cols = [
                    ...
                    {label: "Shipping City", fieldName: "ShippingCity", editable: true,sortable: true},            
                    {label: "Shipping State", fieldName: "ShippingState"},
                    {label: "Shipping PostalCode", fieldName: "ShippingPostalCode", sortable: true},
                    {label: "Shipping Country", fieldName: "ShippingCountry", sortable: true},                                
